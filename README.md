...
- The URL to use is https://github.com/satsdevops/addressbook_project.git
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/vaadin/addressbook_project.git
- Finish
...
- Set the repository URL to https://github.com/satsdevops/addressbook.git
